...
def make_tenant_models(schema: str) -> dict:
    ...
    class InventoryItem(Base):
        ...
        avg_price_per_base_unit: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    class PendingConfirmation(Base):
        ...
        purchase_unit: Mapped[Optional[str]] = mapped_column(String(50), nullable=True)
